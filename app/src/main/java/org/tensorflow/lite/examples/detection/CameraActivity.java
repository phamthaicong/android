...
import org.tensorflow.lite.examples.detection.Retrofit.RetrofitInstance;

import org.tensorflow.lite.examples.detection.Retrofit.Service;
...
public abstract class CameraActivity extends AppCompatActivity
    ...
    private FloatingActionButton btnSwitchCam, btnTest;
...
////        Log.d("Hello","congasdasdasd------------------>");
//        Call<List<PostImage>> req = service.testRetrofit(new PostImage("Pham Thai Cong", "tablet"));
...
////                    List<Candidates> candidatesList = response.body()
//                }
//
//            }
//
...
//        });
//    }
//    private void getUserSusses(){
//        Call<List<PostImage>> req = service.getUserSuccessTest();
//        req.enqueue(new Callback<List<PostImage>>() {
//            @Override
//            public void onResponse(Call<List<PostImage>> call, Response<List<PostImage>> response) {
//                Log.d("dataGet",response.body().toString());
//            }
//
//            @Override
//            public void onFailure(Call<List<PostImage>> call, Throwable t) {
